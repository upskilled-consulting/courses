...
const SITE_URL = (process.env.SITE_URL  || 'https://upskilled.consulting').replace(/\/$/, '');
...
module.exports = { BASE, SITE_URL, DIST, escHtml, headingSlug, navItemUrl, href, relPrefix, writeFile, BACK_SVG };
